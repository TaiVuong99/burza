...
function Footer() {
  ...
  return (
    <>
      {location.pathname !== "/ad" && location.pathname !== `/ad/dashboard` && location.pathname !== `/ad/products` && location.pathname !== `/ad/categories` && location.pathname !== `/ad/orders` && location.pathname !== `/ad/users` && (
          <footer>
